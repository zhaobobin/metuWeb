      ...
      case 'Input':
        ...
        html = (
          <FormItem
            ...
            label={topic.label}
            validateStatus={
              form.isFieldTouched(topic.key) && form.getFieldError(topic.key)
                ? 'error'
                : ''
            }
            help={
              (form.isFieldTouched(topic.key) &&
                form.getFieldError(topic.key)) ||
              ''
            }
          >
            {form.getFieldDecorator(topic.key, {
              ...
              rules: [
                ...
                {
                  validator:
                    topic.validator === 'password' ? this.checkConfirm : null,
                },
              ],
            })(
              <Input
                ...
                onFocus={
                  topic.checkPsdLevel ? this.changePsdLevelVisible : null
                }
                ...
                suffix={
                  <span className={styles.suffix}>
                    ...
                    <em className={styles.suffixText}>
                      {topic.suffix ? topic.suffix : null}
                    </em>
                  </span>
                }
              />,
          ...
          >
            {form.getFieldDecorator(topic.key, {
              ...
              <Select
                ...
                size="large"
                onChange={
                  topic.onValuesChange ? this.onValuesChange(topic.key) : null
                }
              >
            ...
            {form.getFieldDecorator(topic.key, {
              ...
              <InputSmscode
                ...
                mobile={
                  topic.mobile
                    ? topic.mobile
                    : Validator.hasErrors(form.getFieldsError([topic.telKey]))
                    ? ''
                    : form.getFieldValue(topic.telKey)
                }
                api={topic.api}
                callback={(value) => {
            ...
            {topic.btns.map((btn, k) => (
              <Button
                ...
                disabled={
                  topic.disabled ||
                  (btn.htmlType === 'submit' &&
                    Validator.hasErrors(form.getFieldsError())) ||
                  (btn.htmlType === 'reset' &&
                    initValidate &&
      ...
      <Row key={index} gutter={{ md: 8, lg: 24, xl: 48 }}>
        {item.map((topic, key) => (
          <Col
            ...
            sm={24}
            xs={24}
            md={layout === 'horizontal' ? parseInt(24 / item.length, 10) : 24}
          >
            {this.getFormItem(
              topic,
              form,
    ...
    return (
      <div className={styles.formInit}>
        {modal ? (
          ...
          >
            <Form hideRequiredMark={true} className={styles.modalForm}>
              {inputBox}
            </Form>
          </Modal>
        ) : (
